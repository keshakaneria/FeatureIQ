...
export function FeatureForm({ selectedProductName, editingFeature, onSave, onCancelEdit, allFeatures = [] }) {
  ...
  return (
    <section ref={formRef} id="feature-input" className="rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-[0_32px_120px_-20px_rgba(0,0,0,0.08)]">
      <div className="grid gap-10 xl:grid-cols-[1fr_380px]">
        ...
        <aside className="relative">
          <div className="sticky top-10 space-y-6">
            <div className="rounded-[2.5rem] border border-indigo-100 bg-gradient-to-br from-indigo-600 to-indigo-700 p-8 text-white shadow-2xl shadow-indigo-200">
              <p className="text-[11px] font-black uppercase tracking-[0.2em] text-indigo-200">
                Strategic Intelligence
              </p>
              <div className="mt-8 flex flex-col items-center text-center">
                <div className="relative">
                  <svg className="h-40 w-40 -rotate-90">
                    <circle cx="80" cy="80" r="74" className="stroke-indigo-500 fill-none" strokeWidth="8" />
                    <circle 
                      cx="80" cy="80" r="74" 
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <p className="text-xs font-bold text-indigo-200 mt-1">ROI SCORE</p>
                  </div>
                </div>
                ...
                {previewRank && (
                  <motion.div 
                    ...
                    className="mt-8 inline-flex items-center gap-2 rounded-2xl bg-white/10 px-6 py-3 backdrop-blur-xl border border-white/20"
                  >
                    <p className="text-sm font-bold uppercase tracking-widest text-indigo-100">Ranked:</p>
